...
/**
 *  Test if trace is enabled globally.
 *
 *  @return
 *     true if trace is enabled globally, false otherwise.
 */
__rte_experimental
bool rte_trace_global_is_enabled(void);

/**
 * Test if trace is disabled globally.
 *
 * @return
 *    true if trace is disabled globally, false otherwise.
 */
__rte_experimental
 ...
 *    The trace object.
 * @return
 *    true if trace is invalid, false otherwise.
 */
__rte_experimental
bool rte_trace_id_is_invalid(rte_trace_t *trace);
 ...
 * rte_trace_ctf_* macros, Use ";" delimiter between two payloads.
 *
 * @see rte_trace_fp_is_enabled, RTE_TRACE_POINT
 */
