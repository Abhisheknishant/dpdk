...
- Groups, E-Switch steering, fast inseration rate are supported only with Mellanox OFED 4.6.2 and above.
...
- Minimal kernel version : v4.14 or the most recent 5.1.0-rc (see `Linux installation documentation`_)
