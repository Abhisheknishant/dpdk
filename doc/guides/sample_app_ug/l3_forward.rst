...
* ``--eventq-sync:`` Optional, Event queue synchronization method, Ordered or Atomic. Only valid if --mode=eventdev.
...
.. code-block:: console
    ...
    ./build/l3fwd -l 0-3 -n 4 -w <event device> -- -p 0x3 --eventq-sync=ordered

or

.. code-block:: console

    ./build/l3fwd -l 0-3 -n 4 -w <event device> -- -p 0x03 --mode=eventdev --eventq-sync=ordered
...
*   The --eventq-sync option enables synchronization menthod of event queue so that packets will be scheduled accordingly.
...
.. code-block:: console
    ...
    ./build/l3fwd -l 0-7 -s 0-3 -n 4 --vdev event_sw0 -- -p 0x3 --mode=eventdev --eventq-sync=ordered
